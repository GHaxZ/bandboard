...
/** Desktop nav pill — render inside the header. */
...
/**
 * Mobile bottom tab bar — MUST render outside the header: the header's
 * backdrop-blur makes it the containing block for fixed children, which
 * would pin this bar under the logo instead of the viewport bottom.
 */
